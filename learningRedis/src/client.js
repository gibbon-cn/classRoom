...
var RedisClient = /** @class */ (function () {
    ...
    Object.defineProperty(RedisClient.prototype, "getAsync", {
        get: function () {
            if (this._getAsync)
    ...
    Object.defineProperty(RedisClient.prototype, "setAsync", {
        get: function () {
            if (this._setAsync)
    ...
    RedisClient.prototype.get = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAsync(key)];
    ...
    RedisClient.prototype.set = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setAsync(key, value)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
